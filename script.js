...
Sparky.historical = {
  ...
  document.querySelector("#Western").onchange = function() {
		if(this.checked) {
	...
	document.querySelector("#Adult").onchange = function() {
		if(this.checked) {
	...
	document.querySelector("#Professional").onchange = function() {
		if(this.checked) {
	...
	document.querySelector("#Paranormal").onchange = function() {
		if(this.checked) {
	...
	document.querySelector("#Thriller").onchange = function() {
		if(this.checked) {
	...
	document.querySelector("#Historical").onchange = function() {
		if(this.checked) {
	...
	Sparky.generate = function(){
		...
		document.querySelector('#box').innerHTML = sentence;
	};
...
document.querySelector("#close_about").onclick = function(){
  document.querySelector("#about_card").style.display = "none";
  document.querySelector("#overlay").style.display = "none";
}

document.querySelector("#open_about").onclick = function(){
...
document.querySelector('#generate').ontouchstart = function(){
  Sparky.generate();
}


let generateButton = document.querySelector('#generate');
let rect = generateButton.getBoundingClientRect();
console.log(rect)
...
let emit = function(){
  ...
  generateButton.addEventListener('mousedown', (e) => { e.preventDefault(); emit() });
  generateButton.addEventListener('touchstart', (t) => { t.preventDefault(); emit() });
  generateButton.addEventListener('mouseup', stop);
  generateButton.addEventListener('touchend', stop);
